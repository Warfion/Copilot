...
A personal collection of prompts — not just for Copilot, but also for specific agents like **Copilot Cowork**, **Researcher**, and more.

Browse the `prompts/` folder to find ready-to-use prompts organized by agent.
